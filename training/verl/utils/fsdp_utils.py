...
def get_fsdp_wrap_policy(module, config=None, is_lora=False):
    ...
    if isinstance(default_transformer_cls_names_to_wrap, set):
        # transformers >= 5.0 sets _no_split_modules as a set on instances.
        default_transformer_cls_names_to_wrap = list(default_transformer_cls_names_to_wrap)
...
def apply_fsdp2(model, fsdp_kwargs, config):
    ...
    if isinstance(fsdp_transformer_layer_cls_to_wrap, str):
        ...
        # transformers >= 5.0 sets _no_split_modules as a set on instances; convert to list.
